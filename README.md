...
Hello! I am known as `sceewhiz12`. I am a hobbyist programmer, mostly working on stuff related to [Minecraft Forge][forge] and mods made using Forge. I am also an administrator on the [Forge Community Wiki][fcw], a maintainer of the [FCW: JavaDocs project][fcw_javadocs], and the current toolchain team lead of [ParchmentMC][parchment].
